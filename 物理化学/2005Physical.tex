...
某一级反应在$450\ \mathrm{K}$和$500\ \mathrm{K}$时速率常数分别为$3.67\times10^{-7}\ \mathrm{s^{-1}}$和$5.12\times10^{-5}\ \mathrm{s^{-1}}$，求该反应的活化能$E_\mathrm{a}$和$500\ \mathrm{K}$时的活化熵$\Delta^\ddagger S_\mathrm{m}^\ominus$、活化焓$\Delta^\ddagger H_\mathrm{m}^\ominus$。

\vspace{0.5cm}
\noindent\textbf{5. (15 pts.)}

电池$\ce{Pt,H_{2}}(g)(p^\ominus)|\ce{NaOH}(aq)|\ce{HgO}(s),\ce{Hg}(l),\ce{Pt}$在$298\ \mathrm{K}$时的电动势$E = 0.9261\ \mathrm{V}$。
