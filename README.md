...
试卷识别采用OCR2.0+GraphRAG实现，所使用的模型不一定很聪明，最终生成的.tex文件仅经过了很粗略的审校。如果您发现成品出现排版或识别错误，欢迎提出。

此外，题目传播过程中难免出现错漏，不同来源的真题内容甚至可能存在冲突。如果您能联系我们并提供更准确的题目，我们将第一时间修正并谨代表其他用户表示感谢。缺失：25年部分内容、26物化部分内容、21无机

部分内容有删改。具体来说，只保留了当今仍在考纲内且有所考察的主要内容和知识点。例如早期物理化学的结构化学部分、分析化学的仪器分析部分、有机实验题等等都未收录。(如果真的有需要的话大概会补上的，大概)
...
## TODO
* [x] 无机化学(20年以前分开考四大化，20年后分为无机物化、有机分析两科考试，后略)
* [x] 物理化学
* [x] 分析化学
* [x] 有机化学
 <span style="color: gray; font-size: 0.9em;">- 结构式识别尚有难题，等待并心怀希望吧……</span>
* [x] 无机物化
* [x] 有机分析
* [ ] 无机化学答案和解析
* [ ] 有机化学答案和解析
